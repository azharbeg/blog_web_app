<footer class="text-center">
          copyright &copy: by <a href="#">Azhar Beg 2020 - <?php echo date('Y')?> </a>
        </footer>
        <script src="https://cdn.tiny.cloud/1/kb6v28u3hk65f1zcod2l20gjyy9jnx7yar96hb9hqbhxlqku/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
 <script>
